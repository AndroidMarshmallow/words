...
import com.yukon.absenceplanner.mobile.android.main_activity.absence_info_fragment_for_manager.presenter.AbsenceInfoPersonsFragmentPresenter;
import com.yukon.absenceplanner.mobile.android.main_activity.absence_info_fragment_for_manager.presenter.AbsenceInfoPersonsFragmentPresenterImpl;
import com.yukon.absenceplanner.mobile.android.main_activity.absence_info_fragment_for_manager.view.cancel_alert_dialog.CancelDialogClass;
...
public class AbsenceInfoFragmentForManager extends android.support.v4.app.Fragment implements AbsensInfoFragmentViewForManager,
    ...
    private AbsenceInfoAdapterForManager mRecyclerViewAdapter;

    private AbsenceInfoPersonsFragmentPresenter absenceInfoPersonsFragmentPresente;

    public static android.support.v4.app.Fragment newInstance() {
        return new AbsenceInfoFragmentForManager();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.absence_info_for_manager,container,false);
        ...
        mRecyclerViewAdapter = new AbsenceInfoAdapterForManager(null, this, this,getContext());
    ...
    public void onSuccessForAbsences(Absences absences ) {
        try {
            ...
            if (absences == null) {
                mRecyclerViewAdapter = new AbsenceInfoAdapterForManager(listAbsence, this, this, getContext());
                superRecyclerView.setAdapter(mRecyclerViewAdapter);
